...
# post_wb = load_workbook(r"/GMB/Posting/Data/Posting post urls.xlsx")
    ...
    for data in driver.find_elements(By.CLASS_NAME,"p4HiUc"):
        ...
        for head in data.find_elements(By.CLASS_NAME,"LgQiCc"):
            ...
            for date_value in head.find_elements(By.CLASS_NAME,"PROnRd"):
                ...
                l = l + 1
                # wb.save(r"D:\Durai\GMB\Total_Posting_Count\Save Data\count 1-100 "+ date +".xlsx")
                wb.save(r"/Users/mani/Desktop/Python/Posting/Total_Posting_Count/Save Data/count 1-100 " + date + ".xlsx")
driver.quit()
